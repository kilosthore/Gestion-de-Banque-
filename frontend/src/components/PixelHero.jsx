...
/* ─── Mini-helper de classes (remplace `cn` de shadcn/clsx) ─── */
const cx = (...parts) => parts.filter(Boolean).join(' ');

/* ─────────────────────────────────────────────────────────────
 * LOGOS DE MARQUE (rangée de marquee)
 * ──────────────────────────────────────────────────────────── */
const BRAND_LOGOS = [
  () => (
    <svg
    ...
    <div className="relative w-full min-h-[100dvh] bg-background flex flex-col justify-between md:justify-center md:gap-6 py-8 md:py-0 px-2 sm:px-6 overflow-hidden select-none isolate">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div
          ...
          style={{
            backgroundImage:
              'radial-gradient(circle at center, transparent 0%, rgb(var(--hue-background)) 100%)',
          }}
        />
      </div>
