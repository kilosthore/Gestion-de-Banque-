  ...
  return (
    <Popover.Root>
      <Popover.Trigger
        ...
        className="inline-flex items-center justify-center rounded-lg border border-primaire-200 dark:border-sombre-bordure bg-white dark:bg-sombre-surface p-2 text-slate-600 dark:text-primaire-400 hover:bg-primaire-100 dark:hover:bg-sombre-surface2 focus:outline-none focus:ring-2 focus:ring-primaire-500 focus:ring-offset-2 transition-colors"
      >
      ...
      <Portal>
        <Popover.Positioner>
          ...
          >
            ...
            <Popover.Title className="mb-2 text-sm font-bold text-primaire-700 dark:text-primaire-100">
              {titre}
            </Popover.Title>
            <Popover.Description className="text-sm text-slate-600 dark:text-primaire-400">
              {description}
            </Popover.Description>
          </Popover.Content>
        </Popover.Positioner>
